...
function FormAgent() {
    ...
    <img class="h-20 w-20 object-cover rounded-full" src="/src/img/1.png" alt="" />
      ...
      <img class="h-30 w-30" src="src/img/stock-photo--d-illustration-flag-of-gabon-on-stand-greeting-card-national-independence-day-of-the-gabon-2356877897-removebg-preview (1).png" alt="" />
