...
function FemmeSage() {
    return(
      ...
      <div class="bg-white h-100 w-2/5 p-8 rounded-l-lg">
      <img class="h-20 w-20 object-cover rounded-full" src="/src/img/1.png" alt="" />
        <p class="whitespace-pre-line w-1/1">"Rejoignez la communauté iBota : Transformez chaque naissance en une expérience exceptionnelle en vous inscrivant dès maintenant. Ensemble, simplifions l'enregistrement des naissances avec douceur et efficacité."</p>
        <img class="h-30 w-30" src="src/img/medical-5459650_640.png" alt="" />
  
      </div>
      <div class="bg-cyan-200 h-100 w-2/5 rounded-r-lg flex flex-col items-center p-8 ">
